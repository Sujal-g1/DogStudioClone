  ...
  return (
   ...
   <main>
    ...
    <div className="images">
     <img id='tomorrow' src="/tomorrow.png" alt="" />
     <img id='navy' src="/navy.png" alt="" />
     <img id='chicago' src="/chicago.png" alt="" />
     <img id='phone' src="/phone.png" alt="" />
    <img id='festival' src="/festival.png" alt="" />
   ...
   style={{
    ...
    <section id="section1">
      ...
      <nav>
         ...
         <svg xmlns="http://www.w3.org/2000/svg" fill='whitesmoke' viewBox="0 0 401.23099 116.838">
      ...
      <div className="bottom">
        ...
        <div className="right">
          ...
          <p className='para-2'>
            Our goal is to deliver amazing experiences that make <br /> people talk, and build strategic value for brands, tech, <br /> entertainment, arts & culture.
          </p>
          <p className='para-3'>
            Facebook &nbsp; / &nbsp;   Instagram &nbsp; / &nbsp; Dribble &nbsp; / &nbsp; Twitter &nbsp; / &nbsp; Newsletter
          </p>
        </div>
      </div>
    ...
    <div className="titles">
      ...
      <div img-title='tomorrow' className="title">
      ...
      <div img-title='festival' className="title">
